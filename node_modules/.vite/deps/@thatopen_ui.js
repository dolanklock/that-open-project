...
var Ms = (i, t, e) => t in i ? Rs(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
var Us = async (i, t, e) => {
  ...
  for (let v = 0; v < a.length; v++) {
    ...
    }, S && b <= 50 && (b++, typeof S == "object" && (S.placement && (f = S.placement), S.rects && (c = S.rects === true ? await o.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : S.rects), {
...
function tn(i) {
  return typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof R(i).ShadowRoot;
}
function re(i) {
  const {
    overflow: t,
...
function Zs(i, t, e) {
  return t === void 0 && (t = false), !e || t && e !== R(i) ? false : t;
}
function Gt(i, t, e, s) {
...
function er(i) {
  ...
  const r = n === "fixed", o = mt(s), a = t ? Wn(t.floating) : false;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
...
function rr(i, t) {
  const e = Gt(i, true, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = V(i) ? Pt(i) : rt(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function Yn(i, t) {
  const e = It(i);
  return e === t || !G(e) || Me(e) ? false : M(e).position === "fixed" || Yn(e, t);
}
function or(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = ii(i, [], false).filter((a) => G(a) && ot(a) !== "body"), n = null;
...
function cr(i, t, e) {
  const s = V(t), n = mt(t), r = e === "fixed", o = Gt(i, true, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
var ge = globalThis;
var vi = ge.ShadowRoot && (ge.ShadyCSS === void 0 || ge.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var yi = Symbol();
...
var fr = (i) => new ts(typeof i == "string" ? i : i + "", void 0, yi);
var C = (i, ...t) => {
...
var rn = vi ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules)
    e += s.cssText;
  return fr(e);
})(i) : i;
var { is: mr, defineProperty: br, getOwnPropertyDescriptor: gr, getOwnPropertyNames: vr, getOwnPropertySymbols: yr, getPrototypeOf: _r } = Object;
var it = globalThis;
var on = it.trustedTypes;
var xr = on ? on.emptyScript : "";
var We = it.reactiveElementPolyfillSupport;
var Ut = (i, t) => i;
var we = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? xr : null;
      break;
...
var _i = (i, t) => !mr(i, t);
var ln = { attribute: true, type: String, converter: we, reflect: false, hasChanged: _i };
...
var qt = globalThis;
var $e = qt.trustedTypes;
var an = $e ? $e.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var es = "$lit$";
var et = `lit$${Math.random().toFixed(9).slice(2)}$`;
var is = "?" + et;
var wr = `<${is}>`;
var $t = document;
var Xt = () => $t.createComment("");
var Jt = (i) => i === null || typeof i != "object" && typeof i != "function";
var ns = Array.isArray;
var $r = (i) => ns(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Qe = `[ 	
\f\r]`;
var Ft = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var cn = /-->/g;
var un = />/g;
var _t = RegExp(`>|${Qe}(?:([^\\s"'>=/]+)(${Qe}*=${Qe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var hn = /'/g;
var dn = /"/g;
var ss = /^(?:script|style|textarea|title)$/i;
var Cr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var m = Cr(1);
var Ct = Symbol.for("lit-noChange");
var k = Symbol.for("lit-nothing");
var fn = /* @__PURE__ */ new WeakMap();
var xt = $t.createTreeWalker($t, 129);
function rs(i, t) {
...
var Kt = class _Kt {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = _Kt.createElement(c, s), xt.currentNode = this.el.content, e === 2) {
...
function zt(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, false), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = zt(i, n._$AS(i, t.values), n, s)), t;
}
var Ar = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? $t).importNode(e, true);
    xt.currentNode = n;
...
var oe = class _oe {
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new _oe(this.S(Xt()), this.S(Xt()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
var zn;
w._$litElement$ = true, w.finalized = true, (zn = globalThis.litElementHydrateSupport) == null || zn.call(globalThis, { LitElement: w });
var Ge = globalThis.litElementPolyfillSupport;
Ge == null || Ge({ LitElement: w });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.0.5");
var Tr = { attribute: true, type: String, converter: we, reflect: false, hasChanged: _i };
var Lr = (i = Tr, t, e) => {
...
var Ir = (i) => i.strings === void 0;
var os = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var ls = (i) => (...t) => ({ _$litDirective$: i, values: t });
var as = class {
  constructor(t) {
  }
  get _$AU() {
...
var ve = (i, t) => i ? !!((i.provider === "" || i.provider.match(Qt)) && (t && i.prefix === "" || i.prefix.match(Qt)) && i.name.match(Qt)) : false;
function Ur(i, t) {
  const e = {};
...
var yo = /(-?[0-9.]*[0-9]+[0-9.]*)/g;
var _o = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function ci(i, t, e) {
  if (t === 1)
    return i;
...
var Co = (i) => i === "unset" || i === "undefined" || i === "none";
function Ss(i, t) {
  const e = {
    ...ae,
    ...i
...
function Ps() {
  ...
  return {
    enableCache: (e) => En(e, true),
    disableCache: (e) => En(e, false),
    iconLoaded: gn,
    iconExists: gn,
    getIcon: Jr,
    listIcons: Xr,
...
function Do(i = "iconify-icon") {
  ...
  const n = [
    ...
    constructor() {
      super();
      tt(this, "_shadowRoot");
      tt(this, "_initialised", false);
      tt(this, "_state");
      tt(this, "_checkQueued", false);
      tt(this, "_connected", false);
      tt(this, "_observer", null);
      tt(this, "_visible", true);
    ...
    */
     ...
     */
    _gotIconData(l) {
      this._checkQueued = false, this._renderIcon(l, pn(this), this.getAttribute("mode"));
    }
    /**
...
var Bt;
var H = (Bt = class extends w {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._parent = nt(), this._tooltip = nt(), this._contextMenu = nt(), this._mouseLeave = false, this.onWindowMouseUp = (t) => {
...
var ki = class ki2 extends w {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this._colorInput = nt(), this._textInput = nt(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var De = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i;
var Ko = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function Ln(i) {
  const t = Ko.find(
...
var Li = class Li2 extends Jo {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._inputContainer = nt(), this._listElement = nt(), this._visible = false, this._value = [], this.onValueChange = new Event("change"), this.onWindowMouseUp = (t) => {
...
var Mi = class Mi2 extends w {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = nt(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var _ = class _2 {
   ...
   */
  static init() {
    _2.addGlobalStyles(), _2.defineCustomElement("bim-button", Vo), _2.defineCustomElement("bim-checkbox", at), _2.defineCustomElement("bim-color-input", X), _2.defineCustomElement("bim-context-menu", Oe), _2.defineCustomElement("bim-dropdown", B), _2.defineCustomElement("bim-grid", ie), _2.defineCustomElement("bim-icon", fi), _2.defineCustomElement("bim-input", Et), _2.defineCustomElement("bim-label", ct), _2.defineCustomElement("bim-number-input", L), _2.defineCustomElement("bim-option", P), _2.defineCustomElement("bim-panel", ut), _2.defineCustomElement("bim-panel-section", ht), _2.defineCustomElement("bim-selector", dt), _2.defineCustomElement("bim-table", J), _2.defineCustomElement("bim-tabs", K), _2.defineCustomElement("bim-tab", I), _2.defineCustomElement("bim-table-cell", Pe), _2.defineCustomElement("bim-table-children", Te), _2.defineCustomElement("bim-table-group", Le), _2.defineCustomElement("bim-table-row", ft), _2.defineCustomElement("bim-text-input", N), _2.defineCustomElement("bim-toolbar", jt), _2.defineCustomElement("bim-toolbar-group", Mt), _2.defineCustomElement(
      "bim-toolbar-section",
      pt
    ), _2.defineCustomElement("bim-viewport", Ie);
  }
  static newRandomId() {
