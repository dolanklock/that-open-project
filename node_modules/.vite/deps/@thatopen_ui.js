...
var Gs = (i, t, e) => t in i ? Ys(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
function rn(i) {
  return typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof M(i).ShadowRoot;
}
function re(i) {
  const {
    overflow: t,
...
function dr(i, t, e) {
  return t === void 0 && (t = false), !e || t && e !== M(i) ? false : t;
}
function Gt(i, t, e, s) {
...
function pr(i) {
  ...
  const r = n === "fixed", o = ft(s), a = t ? is(t.floating) : false;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
...
function vr(i, t) {
  const e = Gt(i, true, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = U(i) ? Lt(i) : rt(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function ss(i, t) {
  const e = Mt(i);
  return e === t || !K(e) || Me(e) ? false : R(e).position === "fixed" || ss(e, t);
}
function yr(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = ii(i, [], false).filter((a) => K(a) && ot(a) !== "body"), n = null;
...
function xr(i, t, e) {
  const s = U(t), n = ft(t), r = e === "fixed", o = Gt(i, true, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
var me = globalThis;
var vi = me.ShadowRoot && (me.ShadyCSS === void 0 || me.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var yi = Symbol();
var an = /* @__PURE__ */ new WeakMap();
var us = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = true, s !== yi)
...
var Ar = (i) => new us(typeof i == "string" ? i : i + "", void 0, yi);
var C = (i, ...t) => {
...
var cn = vi ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules)
    e += s.cssText;
  return Ar(e);
})(i) : i;
var { is: Or, defineProperty: kr, getOwnPropertyDescriptor: Pr, getOwnPropertyNames: Tr, getOwnPropertySymbols: Lr, getPrototypeOf: Ir } = Object;
var nt = globalThis;
var un = nt.trustedTypes;
var zr = un ? un.emptyScript : "";
var We = nt.reactiveElementPolyfillSupport;
var Vt = (i, t) => i;
var _e = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? zr : null;
      break;
...
var _i = (i, t) => !Or(i, t);
var hn = { attribute: true, type: String, converter: _e, reflect: false, hasChanged: _i };
...
var Tt = class extends HTMLElement {
  ...
  static finalize() {
    if (this.hasOwnProperty(Vt("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Vt("properties"))) {
...
var qt = globalThis;
var we = qt.trustedTypes;
var dn = we ? we.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var wi = "$lit$";
var Y = `lit$${Math.random().toFixed(9).slice(2)}$`;
var xi = "?" + Y;
var Mr = `<${xi}>`;
var wt = document;
var Xt = () => wt.createComment("");
var Jt = (i) => i === null || typeof i != "object" && typeof i != "function";
var hs = Array.isArray;
var ds = (i) => hs(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Qe = `[ 	
\f\r]`;
var Ft = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var fn = /-->/g;
var pn = />/g;
var vt = RegExp(`>|${Qe}(?:([^\\s"'>=/]+)(${Qe}*=${Qe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var mn = /'/g;
var bn = /"/g;
var fs = /^(?:script|style|textarea|title)$/i;
var Rr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var m = Rr(1);
var xt = Symbol.for("lit-noChange");
var S = Symbol.for("lit-nothing");
var gn = /* @__PURE__ */ new WeakMap();
var yt = wt.createTreeWalker(wt, 129);
function ps(i, t) {
...
var Kt = class _Kt {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = _Kt.createElement(c, s), yt.currentNode = this.el.content, e === 2) {
...
function $t(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, false), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = $t(i, n._$AS(i, t.values), n, s)), t;
}
var bs = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? wt).importNode(e, true);
    yt.currentNode = n;
...
var Nt = class _Nt {
  ...
  constructor(t, e, s, n) {
    this.type = 2, this._$AH = S, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? true;
  }
  get parentNode() {
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new _Nt(this.S(Xt()), this.S(Xt()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
var jr = { P: wi, A: Y, C: xi, M: 1, L: ms, R: bs, D: ds, V: $t, I: Nt, H: oe, N: vs, U: ys, B: gs, F: _s };
var Ye = qt.litHtmlPolyfillSupport;
...
var Vn;
x._$litElement$ = true, x.finalized = true, (Vn = globalThis.litElementHydrateSupport) == null || Vn.call(globalThis, { LitElement: x });
var Ge = globalThis.litElementPolyfillSupport;
Ge == null || Ge({ LitElement: x });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.0.5");
var Br = { attribute: true, type: String, converter: _e, reflect: false, hasChanged: _i };
var Nr = (i = Br, t, e) => {
...
var { I: Hr } = jr;
var vn = (i, t) => (i == null ? void 0 : i._$litType$) !== void 0;
var Dr = (i) => {
  var t;
  return ((t = i == null ? void 0 : i._$litType$) == null ? void 0 : t.h) != null;
};
var Fr = (i) => i.strings === void 0;
var yn = () => document.createComment("");
var _n = (i, t, e) => {
  var r;
...
var Ur = {};
var wn = (i, t = Ur) => i._$AH = t;
var xn = (i) => i._$AH;
var Vr = (i) => {
  i._$AR();
};
var ws = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var $i = (i) => (...t) => ({ _$litDirective$: i, values: t });
var Ci = class {
  constructor(t) {
  }
  get _$AU() {
...
var Wt = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const n of e)
    (s = n._$AO) == null || s.call(n, t, false), Wt(n, t);
  return true;
};
var $e = (i) => {
  let t, e;
...
var be = (i, t) => i ? !!((i.provider === "" || i.provider.match(Qt)) && (t && i.prefix === "" || i.prefix.match(Qt)) && i.name.match(Qt)) : false;
function eo(i, t) {
  const e = {};
...
function te(i) {
  const t = typeof i == "string" ? ce(i, true, Zt) : i;
  if (t) {
...
function On(i, t) {
  const e = Ai(t);
  return e === null ? false : (je[i] = e, true);
}
function Be(i) {
  return je[i];
}
...
var Ao = (i) => new Promise((t, e) => {
  const s = typeof i == "string" ? ce(i, true) : i;
  if (!s) {
    e(i);
    return;
  }
...
function Oo(i, t) {
  const e = typeof i == "string" ? ce(i, true, true) : null;
  if (!e) {
    const r = So(i);
    return {
      value: i,
...
var Po = /(-?[0-9.]*[0-9]+[0-9.]*)/g;
var To = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function ci(i, t, e) {
  if (t === 1)
    return i;
...
var Mo = (i) => i === "unset" || i === "undefined" || i === "none";
function Hs(i, t) {
  const e = {
    ...ae,
    ...i
...
function Us() {
  ...
  return {
    enableCache: (e) => zn(e, true),
    disableCache: (e) => zn(e, false),
    iconLoaded: An,
    iconExists: An,
    getIcon: ao,
    listIcons: lo,
...
function Ko(i = "iconify-icon") {
  ...
  const n = [
    ...
    constructor() {
      super();
      it(this, "_shadowRoot");
      it(this, "_initialised", false);
      it(this, "_state");
      it(this, "_checkQueued", false);
      it(this, "_connected", false);
      it(this, "_observer", null);
      it(this, "_visible", true);
    ...
    */
     ...
     */
    _gotIconData(l) {
      this._checkQueued = false, this._renderIcon(l, $n(this), this.getAttribute("mode"));
    }
    /**
...
var Bt;
var H = (Bt = class extends x {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._parent = st(), this._tooltip = st(), this._contextMenu = st(), this._mouseLeave = false, this.onWindowMouseUp = (t) => {
      const { value: e } = this._contextMenu;
      !this.contains(t.target) && e && (e.visible = false);
    }, this.mouseLeave = true, this.addEventListener("click", (t) => t.stopPropagation());
  }
  set mouseLeave(t) {
...
var Ii = class Ii2 extends x {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this._colorInput = st(), this._textInput = st(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Ne = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i;
var cl = ["=", ">", ">=", "<", "<=", "?", "/", "#"];
function Dn(i) {
  const t = cl.filter(
...
var Ri = class Ri2 extends al {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._inputContainer = st(), this._listElement = st(), this._visible = false, this._value = [], this.onValueChange = new Event("change"), this.onWindowMouseUp = (t) => {
  ...
  updateOptionsState() {
    for (const t of this._options)
      t instanceof P && (this._value.includes(t) ? t.checked = true : t.checked = false);
  }
  findOption(t) {
...
var Bi = class Bi2 extends x {
  constructor() {
    super(), this.onValueChange = new Event("change"), this.vertical = false;
  }
  get value() {
    const t = {};
    for (const e of this.children) {
...
var Hi = class Hi2 extends x {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = st(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var Di = class Di2 extends x {
  constructor() {
    super(...arguments), this.onValueChange = new Event("change"), this._hidden = false, this.activationButton = document.createElement("bim-button");
  }
  set hidden(t) {
...
var Un = (i) => Dr(i) ? i._$litType$.h : i.strings;
var kl = $i(class extends Ci {
  constructor(i) {
  ...
  update(i, [t]) {
    ...
    if (e !== null && (s === null || e !== s)) {
      ...
      if (r === void 0) {
        ...
        r = xe(S, o), r.setConnected(false), this.et.set(e, r);
      }
...
var Qi = class Qi2 extends x {
  constructor() {
    super(), this.data = {}, this._table = this.closest("bim-table"), this.onTableIndentationColorChange = (t) => {
      ...
      { rootMargin: "10px" }
    ), this.columns = [], this.isHeader = false;
  }
  get _columnNames() {
...
var Yi = class Yi2 extends x {
  constructor() {
    super(...arguments), this._columnsChange = new Event("columnschange"), this._filteredData = [], this.headersHidden = false, this.minColWidth = "4rem", this._columns = [], this._textDelimiters = {
      comma: ",",
      tab: "	"
    }, this._queryString = null, this._data = [], this.expanded = false, this.preserveStructureOnFilter = false, this.indentationInText = false, this.definition = {}, this._stringFilterFunction = (t, e) => Object.values(e.data).some((n) => String(n).toLowerCase().includes(t.toLowerCase())), this._queryFilterFunction = (t, e) => {
      let s = false;
      const n = di(t) ?? [];
      for (const r of n) {
        if ("queries" in r) {
...
Ot([
  d({ type: String, attribute: "search-string", reflect: true })
...
var Xi = class Xi2 extends x {
  constructor() {
    super(...arguments), this._switchers = [], this.bottom = false, this.switchersHidden = false, this.floating = false, this.onTabHiddenChange = (t) => {
      const e = t.target;
...
var _ = class _2 {
   ...
   */
  static init() {
    _2.addGlobalStyles(), _2.defineCustomElement("bim-button", tl), _2.defineCustomElement("bim-checkbox", at), _2.defineCustomElement("bim-color-input", Z), _2.defineCustomElement("bim-context-menu", Se), _2.defineCustomElement("bim-dropdown", B), _2.defineCustomElement("bim-grid", ie), _2.defineCustomElement("bim-icon", fi), _2.defineCustomElement("bim-input", Ct), _2.defineCustomElement("bim-label", tt), _2.defineCustomElement("bim-number-input", L), _2.defineCustomElement("bim-option", P), _2.defineCustomElement("bim-panel", Et), _2.defineCustomElement("bim-panel-section", ct), _2.defineCustomElement("bim-selector", ut), _2.defineCustomElement("bim-table", V), _2.defineCustomElement("bim-tabs", ht), _2.defineCustomElement("bim-tab", I), _2.defineCustomElement("bim-table-cell", ke), _2.defineCustomElement("bim-table-children", Pe), _2.defineCustomElement("bim-table-group", Te), _2.defineCustomElement("bim-table-row", At), _2.defineCustomElement("bim-text-input", N), _2.defineCustomElement("bim-toolbar", jt), _2.defineCustomElement("bim-toolbar-group", Rt), _2.defineCustomElement(
      "bim-toolbar-section",
      dt
    ), _2.defineCustomElement("bim-viewport", Le);
  }
  static newRandomId() {
